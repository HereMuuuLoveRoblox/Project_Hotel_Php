    ...
    <div class="container border p-4 my-5" style="border-radius: 10px;" id="register">
        ...
        <?php
            if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                ...
                if ($result === true) {
                    echo '<div class="alert alert-success" role="alert">สมัครสมาชิกสำเร็จ! คุณสามารถ <a href="login.php" class="alert-link">เข้าสู่ระบบ</a> ได้เลย.</div>';
                    ...
                    echo '<div class="alert alert-danger" role="alert">เกิดข้อผิดพลาดที่ไม่คาดคิด กรุณาลองอีกครั้งในภายหลัง</div>';
                }
            }
        ?>
        ...
        <form action="" method="POST">
            ...
            <p>มีบัญชีผู้ใช้แล้ว? <a href="login.php" class="text-decoration-none fw-semibold" style="color: <?php echo $hotelTheme['colorPrimary']; ?>;">เข้าสู่ระบบ</a></p>
